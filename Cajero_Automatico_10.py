...
# condicionamos las opciones 
                                  ...
                                  if bil_retiro > 100000:
                                      ...
                                      if bil_retiro >= bil_5 and cant_5 == 0:
                                          ...
                                          if bil_retiro >= 2000 and cant_2 < 4 or bil_retiro > 10000:  # verificacion e cantidad e billetes
                                              ...
                                              print("Se le entregaran:")   # si llegamos hasta acá mostramos la cantidad de billetes necesarios para dispensar el monto 
                       ...
                       if opciones != "6":
                           SoN = input("Desea realizar otra transaccion: S/N > ").lower()         
