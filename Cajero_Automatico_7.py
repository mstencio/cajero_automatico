...
# validamos solo 3 intentos de pin fallido        
...
# cuando ingresamos solicitamos la respuesta de S o N para otra transaccion        
                 while SoN != "N" and SoN != "S":
                    ...
                    while SoN == "S" and opciones != 6:
                       opciones = int(input("""1.Deposito
2.Retiro
3.Saldo
...
# condicionamos las opciones 
                       ...
                       if opciones == 2:
                          ...
                          if aux_retiro == 0 and retiro != 1000 and retiro != 3000:     # se realiza el retiro solo si esta en valores de 1000, no es 1000 ni 3000
                              if retiro <= saldo:
                                  print("Se le entregaran:")
                                  bil_retiro = retiro
                                  while bil_retiro >= bil_20:   #  contamos la cntidad de billetes que se necesitan para alcanzar el monto
                                      bil_retiro -= bil_20
                                      aux_20 +=1
                                  if aux_20 >= 1:
                                     print(aux_20," billetes de ",bil_20)

                                  while bil_retiro >= bil_10:
                                      bil_retiro -= bil_10
                                      aux_10 +=1
                                  if aux_10 >= 1:
                                       print(aux_10," billetes de ",bil_10)
                                     
                                  while bil_retiro == bil_5:
                                      bil_retiro -= bil_5
                                      aux_5 +=1
                                  if aux_5 >= 1:
                                       print(aux_5," billetes de ",bil_5)
                                      
                                  while bil_retiro >= bil_2:
                                      bil_retiro -= bil_2
                                      aux_2 +=1                       
                                  if aux_2 >= 1:
                                       print(aux_2," billetes de ",bil_2)
                       ...
                       if opciones == 4:
                          print("Cuentas favoritas: ")
                         # for y in transferencia:
                          #    print("> ",y)
                          ...
                          if  cliente_trans in transferencia.keys():
                              ...
                              print(cliente_trans, " no esta en sus cuentas favoritas")
...
print("Gracias por utilizar los servicios del Banco Nacional")
